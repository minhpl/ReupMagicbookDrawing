        ...
        btCon.onClick.AddListener(() =>
        {
            if(mode == MODE.FRAME)
            {
                ...
                ScreenshotHelper.iCaptureWithCamera(cam, (Texture2D tex_) =>
                {
                    ...
                    Texture2D resultTexture = new Texture2D(tex_.width, tex_.height, TextureFormat.RGBA32, false);
                    ...
                    {                        
                        ...
                        Texture2D thumbTex = new Texture2D(GVs.lwidthThumb, height, TextureFormat.BGRA32, false);
                        Utils.matToTexture2D(resultMat, thumbTex);
                        File.WriteAllBytes(thumb, thumbTex.EncodeToPNG());
                        Destroy(thumbTex);
                        resultMat.Dispose();
                    }
            ...
            else
            {
                ...
                Texture2D resultTexture = new Texture2D(texture.width, texture.height, TextureFormat.RGBA32, false);
