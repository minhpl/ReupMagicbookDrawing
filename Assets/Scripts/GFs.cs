...
public class GFs
{
    ...
    public static string getHistoryPath()
    {
        ...
        string ANDROID_DIR_PATH_HISTORY = "data/data/" + Application.identifier + "/files/history/" + perUserDir + "/";
        const string IPHONE_DIR_NAME_HISTORY = "history";
        const string PC_DIR_NAME_HISTORY = "history";
        ...
        else
        {
            ...
            if (Application.platform == RuntimePlatform.IPhonePlayer)
            {
                dir = appPath + IPHONE_DIR_NAME_HISTORY + "/" + perUserDir + "/";
            }
            else
            {
                dir = appPath + PC_DIR_NAME_HISTORY + "/" + perUserDir + "/";
            }
        }
